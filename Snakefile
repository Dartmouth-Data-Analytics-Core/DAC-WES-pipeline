...
# README! Before running this pipeline, you need to run script 001_prepare_bed_list.bash
# to generate files needed in the global scope for running this pipeline!
